...
namespace Striked3D.Math
{
    ...
    {
#if MATHF
        private const float RotationEpsilon = 0.001f * System.MathF.PI / 180f;     // 0.1% of a degree
#else
        private const float RotationEpsilon = 0.001f * ((float) System.Math.PI) / 180f;     // 0.1% of a degree
#endif
