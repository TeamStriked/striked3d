...
#if MATHF
        private const float BillboardMinAngle = 1.0f - (0.1f * (System.MathF.PI / 180.0f)); // 0.1 degrees
#else
        private const float BillboardMinAngle = 1.0f - (0.1f * (((float) System.Math.PI) / 180.0f)); // 0.1 degrees
#endif
