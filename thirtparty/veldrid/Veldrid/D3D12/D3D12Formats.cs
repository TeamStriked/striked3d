...
namespace Veldrid.D3D12
{
    internal static class D3D12Formats
    {
        ...
        internal static Vortice.Direct3D12.StencilOperation VdToD3D11StencilOperation(StencilOperation op)
        {
            switch (op)
            {
        ...
        internal static Vortice.Direct3D12.MapMode VdToD3D11MapMode(bool isDynamic, MapMode mode)
        {
            switch (mode)
            {
                case MapMode.Read:
                    return Vortice.Direct3D12.MapMode.Read;
                case MapMode.Write:
                    return isDynamic ? Vortice.Direct3D12.MapMode.WriteDiscard : Vortice.Direct3D12.MapMode.Write;
                case MapMode.ReadWrite:
                    return Vortice.Direct3D12.MapMode.ReadWrite;
                default:
