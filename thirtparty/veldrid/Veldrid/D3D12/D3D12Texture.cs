...
namespace Veldrid.D3D12
{
    internal class D3D12Texture : Texture
    {
        ...
        public ID3D12Resource DeviceTexture { get; }
        ...
        public D3D12Texture(ID3D12Texture2D existingTexture, TextureType type, PixelFormat format)
        {
        ...
        private protected override TextureView CreateFullTextureView(GraphicsDevice gd)
        {
            ...
            D3D12GraphicsDevice D3D12GD = Util.AssertSubtype<GraphicsDevice, D3D12GraphicsDevice>(gd);
            return new D3D12TextureView(d3d11GD, ref desc);
        }
