...
namespace Veldrid
{
    ...
    public abstract class CommandList : DeviceResource, IDisposable
    {
        ...
        {
            PushConstant((ReadOnlySpan<T>)source);
        }
            ...
            T source) where T : unmanaged
        {
            ...
            {
                PushConstant((IntPtr)ptr, (uint)sizeof(T));
            }
        }
        ...
        public void PushConstant(
            ...
            uint sizeInBytes)
        {
            PushConstantCore(source, sizeInBytes);
        }

        private protected abstract void PushConstantCore(IntPtr source, uint sizeInBytes);
